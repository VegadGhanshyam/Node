...
const alph = (start1: string, end1: string, gap: number) => {
  let i;
...
const fullname = (fullname: string, fun2: any) => {
  return fullname + " " + fun2;
};
const surname = (surname: string) => {
  return surname;
};
